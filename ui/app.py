...
class ExtractorApp:
    ...
    def _create_menu(self):
        ...
        consultas_menu.add_command(label="👥 Consultar Clientes", command=self._open_cliente_search)
        consultas_menu.add_command(label="🏭 Consultar Fornecedores", command=self._open_fornecedor_search)
    ...
    def _create_widgets(self):
        ...
        lbl_welcome = ttk.Label(center_frame, text="BEM-VINDO AO SISTEMA", font=("Helvetica", 20, "bold"))
        lbl_welcome.pack(pady=20)
        
        lbl_subtitle = ttk.Label(center_frame, text="Selecione uma ferramenta no menu acima ou use os atalhos abaixo:", font=("Helvetica", 11))
